...
import com.aaliezl.master.tetris.logic.untils.logInit
...
class MainApplication : Application(), Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    override fun attachBaseContext(base: Context?) {
        ...
        logInit(getString(R.string.app_name))
        logInfo(TAG, "attachBaseContext")
    ...
    override fun onTerminate() {
        logInfo(TAG, "onTerminate")
        super.onTerminate()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        logInfo(TAG, "onLowMemory")
    }

    override fun onTrimMemory(level: Int) {
        super.onTrimMemory(level)
        logInfo(TAG, "onTrimMemory: level = $level")
    }
